...
const projectsData = [
  {
    ...
    image: 'images/kekkaiWorkshop.png',
    tags: ['Video', 'Localization', 'AI', 'Automation'],
    category: 'free-software'
  },
  {
    id: 'easypeg',
    url: 'https://easypeg.ora-san.org/',
    image: 'images/easypeg.png',
    tags: ['Video', 'FFmpeg'],
    category: 'free-software'
  },
  {
    ...
    image: 'images/qtFluentWidgets.png',
    tags: ['C++', 'Qt', 'UI'],
    category: 'ui'
  },
  {
    ...
    image: 'images/pysideFluentWidgetsPro.png',
  ...
  },
  {
    ...
    image: 'images/neoBotFramework.png',
  ...
  },
  {
    ...
    image: 'images/EX-FMBE-simulator.png',
  ...
  },
  {
    ...
    image: 'images/Touhou-Chabangeki-Collect.jpeg',
    tags: ["Touhou"],
    category: 'touhou'
  },
  {
...
const messages = {
  en: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "FFmpeg-powered batch video processing with a visual task queue, advanced encoding parameters, and 12 built-in tools.",
  ...
  zh: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "基于 FFmpeg 的批量视频处理工具，提供可视化任务队列、高级编码参数与 12 个内置工具。",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  ja: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "FFmpeg によるバッチ動画処理ツール。ビジュアルなタスク キュー、高度なエンコード パラメータ、12 の内蔵ツールを備えています。",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  ko: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "시각적 작업 대기열, 고급 인코딩 매개변수 및 12개의 내장 도구를 갖춘 FFmpeg 기반 일괄 비디오 처리 도구입니다.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  fr: {
    ...
    "hero.sponsorButton": "Nous soutenir",
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Traitement vidéo par lots propulsé par FFmpeg, avec file de tâches visuelle, paramètres d'encodage avancés et 12 outils intégrés.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  es: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Procesamiento de vídeo por lotes con FFmpeg, con cola de tareas visual, parámetros de codificación avanzados y 12 herramientas integradas.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  pt: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Processamento de vídeo em lote com FFmpeg, com fila de tarefas visual, parâmetros de codificação avançados e 12 ferramentas integradas.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  de: {
    ...
    "hero.sponsorButton": "Unterstützen",
    ...
    "projects.items.kekkaiWorkshop.name": "Kekkai Workshop",
    "projects.items.kekkaiWorkshop.desc": "Video-Lokalisierungsassistent mit Projektverwaltung, Untertitelextraktion, Video-Download, KI-Übersetzung und Video-Kodierung.",
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "FFmpeg-gestützte Stapelvideoverarbeitung mit visueller Aufgabenwarteschlange, erweiterten Codierungsparametern und 12 integrierten Tools.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  hi: {
    ...
    "hero.sponsorButton": "समर्थन करें",
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "दृश्य कार्य कतार, उन्नत एन्कोडिंग पैरामीटर और 12 अंतर्निहित उपकरणों के साथ FFmpeg-संचालित बैच वीडियो प्रोसेसिंग।",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  tl: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Pagproseso ng batch na video na pinapagana ng FFmpeg, na may visual task queue, advanced encoding parameters, at 12 built-in na tool.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  vi: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Xử lý video hàng loạt dựa trên FFmpeg, với hàng đợi tác vụ trực quan, tham số mã hóa nâng cao và 12 công cụ tích hợp.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
  ...
  ru: {
    ...
    "projects.items.easypeg.name": "Easy FFmpeg",
    "projects.items.easypeg.desc": "Пакетная обработка видео на базе FFmpeg с визуальной очередью задач, расширенными параметрами кодирования и 12 встроенными инструментами.",
    "projects.items.neoBotFramework.name": "NEO-Bot-Framework",
...
const supportersData = [
  ...
  { name: "jom(Philippine)", image: "images/contributors/jom.webp" },
];
