...
const messages = {
  ...
  fr: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) est un collectif de développeurs dont le noyau est l\u2019esprit du logiciel libre et la méthode est la collaboration open source.",
  ...
  es: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) es un colectivo de desarrolladores con el espíritu del software libre como núcleo y la colaboración en código abierto como método.",
  ...
  pt: {
    ...
    "nav.contributors": "Colaboradores",
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) é um coletivo de desenvolvedores com o espírito do software livre como núcleo e a colaboração em código aberto como método.",
  ...
  de: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) ist ein Entwicklerkollektiv mit dem Geist freier Software als Kern und Open-Source-Zusammenarbeit als Methode.",
  ...
  tl: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) ay isang kolektibo ng mga developer na may diwa ng malayang software sa panggitnang at open-source na pakikipagtulungan bilang pamamaraan.",
  ...
  vi: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) là một tập thể nhà phát triển lấy tinh thần phần mềm tự do làm cốt lõi và hợp tác mã nguồn mở làm phương pháp.",
  ...
  ru: {
    ...
    "hero.title": 'Connect The World with <span class="accent underline">Goodwill</span>',
    "hero.description": "天机阁 (Fairy Oracle Sanctuary) — это коллектив разработчиков, чьим стержнем является дух свободного ПО, а методом — сотрудничество в открытом исходном коде.",
